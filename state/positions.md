...
- Tranches: T1 64 sh @ avg 38.8161 (incl. fees). **T2 PARTIALLY filled 2026-08-31 (intraday dislocation run)**: 18 of a planned 70 sh @ effective avg 35.21 (incl. fees) — thin book, only 18 sh of liquidity found at/below the 35.30 limit. New broker-verified position: **82 sh @ avg cost 38.0248, total cost basis 3,118.03 RON.** Remaining 52 sh left resting as a day limit order (35.30); next run must check fill/expiry and decide on re-placing the remainder (room remains under the ≤5,500 total-basis cap). Journal: journal/2026-08.md 2026-08-31 (intraday) entry.
